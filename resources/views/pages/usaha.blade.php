    ...
    <section id="content">
        ...
        <div id="badan-usaha" class="lg:px-28 sm:px-10  h-fit min-h-screen py-16">
            <div class="py-10" id="information">
                ...
                <p class="poppins-regular text-[20px]">Ponpes Darul Yatama Wal Masakin memiliki 4 bidang usaha yaitu diantaranya bidang energi, bidang perdagangan, bidang Pertanian, bidang perkebunan, dan kehutanan. Diantara bidang tersebut terdapat 7 unit usaha</p>
            </div>
            {{-- list --}}
            ...
            <x-banner-list src='images/card/toko.webp' class="sm:h-[206px] lg:h-[306px] lg:mb-10  sm:mb-5 lg:text-[50px] sm:text-[30px]">UD. Jumhuriah (Toko Grosir)</x-banner-list>
        </div>
    </section>
@endsection